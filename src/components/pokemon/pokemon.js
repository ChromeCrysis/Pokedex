...
export default class Pokemon extends Component {
  state = {
    ...
    async componentDidMount() {
      ...
      //Retorna a imagem do pokemon
      const imageUrl = pokemonRes.data.sprites.front_default;
      
      //Variável que armazena o valor dos status do pokemon
      ...
      //Conversão de Decimetros para Centimetros
      const height =
        Math.round(pokemonRes.data.height * 100) / 10;
      ...
      <div className="col">
        <div className="card" style={{
          ...
          <div className="card-header">
            <div className="row">
              <div className="col-5">
                <h5>#{this.state.pokemonIndex}<img id="PokeIcon" src={PokeIcon} style={{
                  maxWidth: '2rem'
                }}/>
                </h5>
